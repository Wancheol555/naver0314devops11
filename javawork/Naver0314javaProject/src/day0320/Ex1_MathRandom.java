...
public class Ex1_MathRandom {
	...
	public static void main(String[] args) {
		...
		System.out.println("**Math.raddom()을 이용한 난수 구하기**");
		System.out.println("!.random()시 값");
		for(int i=1;i<=5;i++)
		{
